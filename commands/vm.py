...
@click.option("--disk", default="50", help="Lima Disk space in GiB. Expects a number. i.e. 50 means 50GiB")
@click.option("--memory", default=8, help="Memory allocated for the VM in GiB. Expects a number. i.e. 8 means 8GiB")
@click.option(
    "--connect",
    "-conn",
    is_flag=True,
...
@click.pass_obj
def create(ctx, config, cpus, disk, memory, connect, kubeconfig):
